...
const {successResponse, errorResponse} = require('./libs/response');
   const logStruct = (func, error) => {
    return {'func': func, 'file': 'contract', error}
  }

        const DecplmaxBATABI = [
	{
		"inputs": [],
...
//const DecplmaxBATJString = 

//const DecplmaxBATContract =        



//const provider = new thetajs.providers.HttpProvider(thetajs.networks.ChainIds.Privatenet);
//const contractToDeploy = new thetajs.ContractFactory(DecplmaxBATABI, byteCodeToDeploy, wallet);
